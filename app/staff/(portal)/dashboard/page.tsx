  ...
  return (
    <div className="flex flex-col gap-8">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">Here is a snapshot of your recruitment pipeline.</p>
      </div>

      {!hasERPNextConfig() ?
        <div className="rounded-xl border border-amber-200/80 bg-amber-50/80 px-5 py-4 text-sm text-amber-950">
          Recruitment backend is not configured. Contact your administrator to see live counts.
        </div>
      : null}
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        {statCard({
          ...
          href: `${STAFF_PORTAL_BASE}/openings`,
          iconBg: "bg-blue-600",
          icon: (
        ...
        {statCard({
          ...
          href: `${STAFF_PORTAL_BASE}/applicants`,
        ...
        {statCard({
          ...
          value: interviews,
          hint: "View schedule →",
          href: `${STAFF_PORTAL_BASE}/interviews`,
      ...
      <section className="rounded-xl border border-slate-200/80 bg-white p-6 shadow-sm">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <Link
            href={`${STAFF_PORTAL_BASE}/openings/new`}
