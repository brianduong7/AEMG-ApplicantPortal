...
export default async function RecruiterApplicantsPage({ searchParams }: Props) {
  await requireStaffRoles(["d_recruiter", "d_hr", "d_executive", "super_admin"]);
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">
          All job applicants. Optionally filter by job opening.
        </p>
      </div>

      <form className="flex flex-wrap items-end gap-3" method="get" action="/staff/applicants">
