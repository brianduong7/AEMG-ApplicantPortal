...
export function InterviewTypeCreateDialog({ open, onClose, onCreated }: Props) {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="interview-type-dialog-title"
    >
      <button
        type="button"
      ...
      <div className="relative w-full max-w-md rounded-xl border border-slate-200 bg-white p-6 shadow-xl">
        <div className="flex items-start justify-between gap-3">
          <div>
            <h2 id="interview-type-dialog-title" className="text-lg font-semibold text-slate-900">
              New interview type
            </h2>
            <p className="mt-1 text-sm text-slate-600">Name and optional description only.</p>
          </div>
          <button
            type="button"
            onClick={onClose}
        ...
        <form action={formAction} className="mt-5 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="typeDescription" className="text-sm font-medium text-slate-700">
              Description
            </label>
            <textarea
              id="typeDescription"
              ...
              placeholder="Optional summary of this interview type"
            />
          </div>
          {state?.error ?
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              type="submit"
              disabled={pending}
              className="inline-flex items-center gap-2 rounded-lg bg-[#0a1628] px-4 py-2 text-sm font-semibold text-white hover:bg-[#152a45] disabled:opacity-60"
            >
