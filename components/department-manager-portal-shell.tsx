...
const NAV_LINKS: NavLinkItem[] = [
  {
    href: "/department-manager/dashboard",
    label: "Dashboard",
    match: (p) => p === "/department-manager" || p === "/department-manager/dashboard",
    icon: <IconDashboard className="h-5 w-5 shrink-0" />,
  },
  {
    href: "/department-manager/job-requisitions",
    label: "Job requisitions",
    match: (p) => p.startsWith("/department-manager/job-requisitions"),
    icon: <IconFileText className="h-5 w-5 shrink-0" />,
  },
  {
    href: "/department-manager/openings",
    label: "Job openings",
    match: (p) => p.startsWith("/department-manager/openings"),
    icon: <IconBriefcase className="h-5 w-5 shrink-0" />,
  },
  {
    href: "/department-manager/applicants",
    label: "Job applicants",
    match: (p) => p.startsWith("/department-manager/applicants"),
    icon: <IconUsers className="h-5 w-5 shrink-0" />,
  },
  {
    href: "/department-manager/interviews",
    label: "Interviews",
    match: (p) => p.startsWith("/department-manager/interviews"),
...
export function DepartmentManagerPortalShell({ children, email }: Props) {
  ...
  return (
    <div className="min-h-dvh">
      ...
      >
        ...
        <p className="border-b border-slate-100 px-4 pb-3 text-xs font-medium uppercase tracking-wide text-slate-500">
          Department manager
        </p>
